...
class CartList extends Component {
    ...
    handleSubtotal = (obj) =>{
        ...
        this.state.cartList[this.state.cartList.indexOf(obj)].subtotal = this.state.cartList[this.state.cartList.indexOf(obj)].count * this.state.cartList[this.state.cartList.indexOf(obj)].unitPrice;
    ...
    OrderBoxDisplayBlock = () => {
        this.setState({myOrderBox: {display:"block"}, 
...
render() {
                ...
                <div className="cartBox">
                    ...
                    <div className="cartTableBox">
                        <table className="cartTable">
                            ...
                            <tbody>
                                {/* <Cart/> */}
                              {this.state.cartList.map(item => <Cart key={item.id} count={item.count} id={item.id} obj={item} unitPrice={item.unitPrice} subtotal={item.subtotal} onIncrement={this.handleIncrement} onDecrement={this.handleDecrement} onDelete={this.handleDelete}></Cart>)}
                               <tr className="coupon">
                                    <td colSpan="3">優惠代碼</td>
                                    <td colSpan="2"><input type="text" placeholder="請輸入優惠代碼"/></td>
                                </tr>
                                <tr className="discountText">
                                    <td colSpan="3">
                                        <p>全館活動</p>
                                        <a href="#" alt="">全館 滿 $ <span>2,000</span> 元 免運費</a>
                                    </td>
                                    <td colSpan="2">{this.handleDiscountQualify()}
                                    </td>
                                </tr>
    ...
    <td className="deliverFeeText" colSpan="2">{this.handleDeliverFee()}
                                    </td>
                                </tr>
                                <tr className="totalMoney">
                                    ...
                                    <td colSpan="2">{this.handleGrandTotalMoney()}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div className="loginBox">
                    <h2>加入會員立即獲得<span> 50 </span>點，<span>馬上折抵</span>！</h2>
                    <div className="loginBoxDiv">
                        <div className="btnLogin btnLine" ><img src={line} alt="12"/> LINE會員登入</div>
                        <div className="btnLogin  btnFb" ><i className="fa fa-facebook" aria-hidden="true"></i>FB會員登入</div>
                        <div className="btnLogin btnGoogle"><i className="fa fa-google" aria-hidden="true"></i>GOOGLE會員登入</div>
                        {/* Trigger/Open The Modal  */}
                        <div onClick={this.directBuyModalDisplayBlock} id="myBtn" className="btnLogin btnDirect" ><i className="fa fa-shopping-cart"
                                aria-hidden="true"></i>直接前往結帳</div>
                    </div>
                    ...
                    <div id="myModal" style={this.state.myModal} className="modal">
                        ...
                        <div className="modal-content">
                            <div className="modal-body">
                                <p><i className="fa fa-gift" aria-hidden="true"></i>登入會員，享有更多優惠！</p>
                                <div>
                                    <a href="#">立即登入</a>
                                    <a onClick={this.OrderBoxDisplayBlock} className="btnDirectNext" href="#orderBox">直接結帳</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="orderBox" style={ this.state.myOrderBox }>
                    <div className="orderTableBox">
                        ...
                        <div className="shipAndPaymentCol">
                            <h1>購買資訊</h1>
                            <hr/>
                            <select onChange={this.homeDeliveryInput} defaultValue={0} className="shippingSelect">
                            ...
                            <div className="addressDetail" style={ this.state.myAddressDetail }>
                                <div className="my-style-selector " >
                                </div>
                        ...
                        <div className="billInfo">
                            ...
                            <div className="checkSubscribe">
                                ...
                                <label htmlFor="subscribe">我想收到最新資訊及優惠方案</label><br/>
                            </div>

                            <div className="checkShipping">
                                <input onChange={this.shippingDataInput} type="checkbox" name="shippingData" id="shippingData"/>
                                <label htmlFor="shippingData">收件人同購買人資料</label><br/>
                                <div id="shippingDataDetail" style={this.state.myShippingDataDetail}>
                                    ...
                                    <input className="shippingPhone" type="text" placeholder="請輸入收件人聯絡電話"/>
                                </div>
                            </div>

                            <textarea name="" id="" cols="30" rows="3" placeholder="請輸入備註事項(選填)"></textarea>

                            <div className="checkClause">
                                <input type="checkbox" name="clause" id="clause"/>
                                <label htmlFor="clause">我已閱讀 <a href="#">「售後服務」</a> 並同意。</label><br/>
                            </div>

                            <div className="afterTotalPay">
                                <p>實付金額(TWD)
                                    <span>{this.handleGrandTotalMoney()}</span><a href="#"><i className="fa fa-file-text-o"
