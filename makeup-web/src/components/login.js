...
class Login extends Component {
	...
	u = data => {
		...
		switch (data[0].info) {
			...
			case "success":
				console.log(data);
				if (data[0].customerStatus == "管理員") {
					window.location.href = "/backEnd/prod/1";
				} else {
						...
						<div id="registerForm" className={this.state.registerForm}>
							...
							<div>
								<div className="inputWrap">
									...
									<input type="text" id="username" placeholder="姓名" autoComplete="off" required />
								</div>
