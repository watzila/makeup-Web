...
class ProdPutOnList extends Component {
				...
				<div className="container-fluid ">
						...
						<div className="col my-content">
							<form action>
								...
								<div className="pt-3 form-head">
									<div className="pt-3">
										<h2 className="pt-3 pb-3 text-center"><i className="fa fa-table" />商品管理 / 上架清單</h2>
										<hr />
										<div className="input-group mb-3 d-flex justify-content-center">
											<div className="mb-3 mx-3">
												<a name="lastPege" type="submit" className="gray-a my-button">上架中</a>
											</div>
											<div className="mb-3 mx-3">
												<a name="lastPege" type="submit" className="gray-a my-button">已下架</a>
											</div>
											<div className="mb-3 mx-3">
												<a name="lastPege" type="submit" className="gray-a my-button">審核中</a>
											</div>
										</div>
									</div>
								</div>
                    ...
                    <select className="custom-select" id="inputGroupSelect">
												...
												<div className="mb-2 ml-auto form-row align-items-center">
													<label htmlFor="orderSearch" className="col-auto d-inlin-block align-self-center">快速搜尋會員名稱：</label>
													<input className="form-control col form-control-sm" type="search" name="orderSearch" id="orderSearch" />
									...
									<table className="table table-hover p-3">
										...
										<tbody>
											<tr>
												...
												<td>上架</td>
												<td>
													<a name="prodSimpleUpdate" type="submit" className=" my-button mb-2">修改</a>
													<a name="prodCopyUpdate" type="submit" className=" my-button mb-2">複製</a>
													<a name="offShelf" type="submit" className=" my-button mb-2">下架</a>
													<a name="prodDtail" type="submit" className=" my-button mb-2">詳情</a>
												</td>
											</tr>
										</tbody>
									</table>
