...
class Detail extends Component {
  constructor(props) {
    ...
    this.cp = require.context(
      './images/customProduct',
      false,
      /\.(png|jpe?g|svg)$/
    );
              ...
              <section className="infoBox">
                ...
                <div className="buyInfo">
                  ...
                  <p className="price">
                    $
                    <span>
                      {this.state.data == null ? '' : this.state.data[0].total}
                    </span>
                    元
                  </p>
                </div>
                ...
                <div className="otherPreviews" id="otherPreviews">
                  <ul>
                    ...
                    >
                      <img
                        src={
                          this.imgPath.importAll(this.cp)[this.cpImgs[2].style1]
                        }
                        alt="style1"
                      />
                    </li>
                    ...
                    >
                      <img
                        src={
                          this.imgPath.importAll(this.cp)[this.cpImgs[2].style2]
                        }
                        alt="style2"
                      />
                    </li>
                    ...
                    >
                      <img
                        src={
                          this.imgPath.importAll(this.cp)[this.cpImgs[2].style3]
                        }
                        alt="style3"
                      />
                    </li>
