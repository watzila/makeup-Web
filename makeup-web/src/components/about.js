        ...
        <div className="warp">
          ...
          <div className="pro_1">
            <div>
              ...
              <div className="panel">
                <p>緩緩的產品皆為自主研發，於自有工廠進行生產，全程執行嚴格品質控管。我們沒有華麗的廣告，沒有明星的加持，沒有誇大的效果；相反的有著純淨的植物成份，新鮮的製作，充滿著對產品的熱情，幫助很多人在追求美麗的同時，擺脫了長期肌膚上的困擾。
                    </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="panel">
                <p>熱愛動物與大自然，是緩緩在追求美麗的同時堅持的理念，邀請您共同加入我們，成為世界潮流的一份子。為了照顧您的肌膚，緩緩堅持不添加致敏、爭議性成分。</p>
              </div>
            </div>
          </div>
          {/*產品介紹 2*/}
          <div className="pro_2">
            <div>
              ...
              <div className="panel_2">
                <p>緩緩所有產品所有的原料、設計包裝都是百分之百台灣製造，全產品通過SGS檢驗，每一項彩妝都代表著獨特的文化創意。期待透過彩妝的過程，讓自然動人的妝感成為每個人生活中的一部分。</p>
              </div>
            </div>
