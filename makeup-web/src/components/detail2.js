...
class Detail2 extends Component {
  ...
  changeIMG = (img) => {
    ...
    [newProdIMG['img1'], newProdIMG[img]] = [
      newProdIMG[img],
      newProdIMG['img1'],
    ];
    ...
    return (
      <main className="detail2Main">
        <div className="warp">
          ...
          <div className="pro_2">
            <div className="pic_04">
              ...
              <strong>
                ${this.state.data != null ? this.state.data[0].unitPrice : ''}元
              </strong>
              <span
                className="love"
                onClick={(event) => {
        ...
        <div className="warp_2">
          ...
          <div className="pic_7">
            <img
              src={this.imgPath.importAll(this.b)[this.state.prodIMG.img5]}
              alt=""
            />
          </div>
        </div>
